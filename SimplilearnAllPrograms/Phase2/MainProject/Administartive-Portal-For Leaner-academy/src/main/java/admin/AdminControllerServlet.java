...
public class AdminControllerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// if no cookeies
			if (!getCookies(request, response, command, command) && (!command.equals("LOGIN"))) {
	...
	private boolean getCookies(HttpServletRequest request, HttpServletResponse response, String name, String value) throws Exception {
